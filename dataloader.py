...
if __name__ == "__main__":
    image_dir = r"/content/drive/MyDrive/archive/ShanghaiTech/part_A/test_data/images"
    gt_dir = r"/content/drive/MyDrive/archive/ShanghaiTech/part_A/test_data/ground-truth"
